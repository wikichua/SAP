<div class="form-group">
    ...
    <div class="form-control h-auto" id="script-input-div">
        @if (isset($model->queries) && is_array($model->queries))
            ...
            <div class="row mb-1">
                <div class="col-11 d-flex justify-content-center">
                    <textarea type="text" name="queries[]" class="form-control" placeholder="queries" rows="1">{{ $val }}</textarea>
                </div>
        ...
        <div class="row mb-1">
            <div class="col-11 d-flex justify-content-center">
                <textarea type="text" name="queries[]" class="form-control" placeholder="queries" rows="1"></textarea>
            </div>
            <div class="col-1 d-flex justify-content-end">
                <div class="btn-group" role="group">
                    <button type="button" class="addRow btn btn-outline-primary"><i class="fa fa-plus"></i></button>
