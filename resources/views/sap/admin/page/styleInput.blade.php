<div class="form-group">
    ...
    <div class="form-control h-auto" id="style-input-div">
        @if (isset($model->styles) && is_array($model->styles))
            ...
            <div class="row mb-1">
                <div class="col-11 d-flex justify-content-center">
                    <textarea type="text" name="styles[]" class="form-control" placeholder="styles" rows="1">{{ $val }}</textarea>
                </div>
        ...
        <div class="row mb-1">
            <div class="col-11 d-flex justify-content-center">
                <textarea type="text" name="styles[]" class="form-control" placeholder="styles" rows="1"></textarea>
            </div>
            <div class="col-1 d-flex justify-content-end">
                <div class="btn-group" role="group">
                    <button type="button" class="addRowStyle btn btn-outline-primary"><i class="fa fa-plus"></i></button>
