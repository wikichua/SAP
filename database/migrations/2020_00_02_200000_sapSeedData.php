...
class SapSeedData extends Migration
{
    public function up()
    {
        ...
        app(config('sap.models.permission'))->createGroup('Permissions', ['Create Permissions', 'Read Permissions', 'Update Permissions', 'Delete Permissions', 'Replicate Permissions'], $user_id);
